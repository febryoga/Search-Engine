...
if($_FILES['img']['name']){
	...
	if(!$_FILES['img']['error']){
		...
		if($valid_file == true)
		{
			...
			// simpan ke database
			mysqli_query($koneksi, "INSERT INTO sosmedpost SET node='$node', adminID='8', judul='$judul', tanggal='$tanggal', tanggal_post='$tanggalpost', img='$nama_file_baru',detail='$detail'");
