...
//        query
        $sql =  "SELECT * FROM sosmedpost ORDER BY id DESC";
...
$no =1;
  ...
  <td><center><img src="../assets/images/sosmed/<?php echo $data['img'];?>"  style="width:70px;height:80px;" alt=""></center></td>
  <td><?php echo  substr ($data['detail'],0, 20); ?><span>....</span></td>
<td>
      <center>
         <a href="#" class='open_modal btn btn-info' id='<?php echo  $data['id']; ?>'><span class="glyphicon glyphicon-pencil"></span></a>
         <a href="#" class="btn btn-danger" onclick="confirm_modal('del_sosmed.php?&id=<?php echo  $data['id']; ?>');"><span class="glyphicon glyphicon-trash"></span></a>
      </center>
      </td>
  </tr>
<?php
...
<div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header" style="text-align:center;background:#4682b5;color:#fff;color:#fff;">
            ...
            <h4 class="modal-title" id="myModalLabel">Tambah Sosmed</h4>
        </div>

        <div class="modal-body">
          <form action="tambah_sosmed.php" name="modal_popup" enctype="multipart/form-data" method="POST">
            ...
            <div class="form-group">
              ...
              <div>
            <textarea rows="5" cols="40" class="texteditor" name="detail" required></textarea>
          </div>
                  </div>
                <div class="form-group" style="padding-bottom: 10px;">
