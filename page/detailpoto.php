    ...
    <section class="site-section">
       ...
       <div class="container">
         <div class="row">
           <div class="col col-sm-12">
             <?php $ambil= $koneksi->query("SELECT * FROM foto WHERE id=$id order by id desc"); ?>
       ...
       <div class="container mt-30">
         <div class="row">
           ...
           <?php $tarik= $koneksi->query("SELECT * FROM fotolist WHERE fotoID='$id' order by id desc"); ?>
           <?php while($gambar = $tarik->fetch_assoc()){ ?>
           ...
           <div class="col col-sm-4">
             <div class="album">
                 ...
                 <div class="media-body">
                   <h3 class="mt-0"><a href="#"><?php echo $gambar['caption'];?></a></h3>
                 </div>
               </div>
             </div>
