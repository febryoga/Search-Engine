                    ...
                    <div class="blog-posts-area">
                        ...
                        <div class="single-blog-post featured-post single-post">
                            <div class="section-heading">
                                <h6> Struktur Pejabat</h6>
                            </div>
                            <nav class="nav nav-tabs nav-justified" style="margin-top: -7%">
                                <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">Bupati</a>
                                <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">Wakil Bupati</a>
                                <a class="nav-item nav-link" id="nav-contact-tab" data-toggle="tab" href="#nav-contact" role="tab" aria-controls="nav-contact" aria-selected="false">Sekretaris Kab</a>
                            </nav>
...
<br>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    ...
                    <!-- Single Featured Post -->
                   <div class="col-5 col-lg-9" style="margin-top: -7%">
