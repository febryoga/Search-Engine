                            ...
                            <div class="classynav">
                              <div class="top-header-content d-flex align-items-center justify-content-between">
                                ...
                                <div class="search-form">
                                    <form action="../pencarianpoto.php" method="get">
    ...
    <section class="site-section">
        <div class="container">
            <div class="popular-news-area section-padding-80-50">
                <div class="row">
                    <?php $ambil= $koneksi->query("SELECT * FROM foto order by id desc limit 10");                            
                    while($perproduk = $ambil->fetch_assoc()){
                    $id= $perproduk ['id']?>
                
                    <a href="detailpoto.php?id=<?php echo $perproduk['id'];?>">
                        <div class="col-md-4 mb-4">               
                            <div class="media d-block room mb-0">
                                <?php $tarik= $koneksi->query("SELECT * FROM fotolist where fotoID=$id ORDER by id desc limit 1");                  
                                while($gambar = $tarik->fetch_assoc()){ ?>
                                <figure>
                                    <img src="../assets/images/photos/<?php echo $gambar['img']; ?>" alt="Generic placeholder image" class="img-fluid">
                                </figure>
                                <?php } ?>
                                ...
                                <div class="media-body">
                                    ...
                                    <form>
                                    <input type="button" value="Detail" onclick="window.location.href='detailpoto.php?id=<?php echo $perproduk['id'];?>'" />
                                    </form>
                                </div>
