                ...
                <div class="col-12 col-lg-8">
                    <div class="blog-posts-area">
                        ...
                        <div class="single-blog-post featured-post single-post">
                          <?php $ambil= $koneksi->query("SELECT * FROM pariwisata WHERE id='$id' "); ?>
                            <?php while($perproduk = $ambil->fetch_assoc()){ ?>
                            <div class="post-thumb">
                                <a href="#"><img src="../assets/images/pariwisata/<?php echo $perproduk['gambar'];?>" alt=""></a>
                            </div>
                            <div class="post-data">
                                ...
                                <div class="post-meta">
                                    <p class="post-author">By <a href="#">Diskominfomas Kep. Seribu</a></p>
                                    <p><?php echo $perproduk['isi'];?></p>

                                    <div class="newspaper-post-like d-flex align-items-center justify-content-between">
                                        <!-- Tags -->
                                        <div class="newspaper-tags d-flex">
                                            <span><a href="#" class="fa fa-eye"><span> <?php echo $perproduk['viewed'];?></span></a></span>
                                        </div>
