                            ...
                            <div class="classynav">
                              <div class="top-header-content d-flex align-items-center justify-content-between">
                                ...
                                <ul>
                                    ...
                                    <li class="active"><a href="pariwisata.php">Pariwisata</a> </li>
...
<div class="popular-news-area section-padding-80-50">
            <div class="row">
              <?php $ambil= $koneksi->query("SELECT * FROM pariwisata limit 3"); ?>
                <?php while($perproduk = $ambil->fetch_assoc()){ ?>
              <div class="col-md-4 mb-4">
                <div class="media d-block room mb-0">
                  <figure>
                    <img src="../assets/images/pariwisata/<?php echo $perproduk['gambar'];?>" alt="Generic placeholder image" class="img-fluid">
                  </figure>
                  <div class="media-body">
                    <h3 class="mt-0"><a href="#"><?php echo $perproduk['judul'];?></a></h3>

                    <form>
                      <input type="button" value="Detail" onclick="window.location.href='single-pulau.php?id=<?php echo $perproduk['id'];?>'"></input>
                    </form>
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved by <a href="https://www.instagram.com/febryogasaputra/" target="_blank">Diskominfotik Kep. Seribu</a>
