...
$qrypakan = mysqli_query($koneksi, "SELECT * from agenda");
@$act = $_GET['act'];
if($act=="tambah"){
...
{
	$kd = $_GET['id'];
	mysqli_query($koneksi, "DELETE from agenda where id='$kd'");
...
<div id="footeradmin fixed-bottom">
