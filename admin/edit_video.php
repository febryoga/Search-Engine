        	...
        	<form action="p_edit_video.php" name="modal_popup" enctype="multipart/form-data" method="POST">
                ...
                <input type="date" name="tanggal" value="<?php echo $d['tanggal'];?>">
                       ...
                       <div class="form-group">
                         ...
                         <input type="text" name="youtubeID"  class="form-control" value="<?php echo $d['youtubeID']; ?>"/>
                       </div>
                       <div class="form-group" style="padding-bottom: 10px;">
                       <label for="berat">Deskripsi</label>

                     <textarea rows="5" cols="40" class="texteditor" name="deskripsi" value="<?php echo $d['deskripsi']; ?>"></textarea>
                   </div>
