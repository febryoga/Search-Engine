...
<div class="popular-news-area section-padding-80-50">
            <div class="row">
              <?php
                 $semuadata=array();
                 $ambil = $koneksi->query("SELECT * FROM foto WHERE judul
                         LIKE '%$keyword%' ");
             ...
             <?php foreach ($semuadata as $key => $value): ?>
              ...
              <div class="col-md-4 mb-4">
                <div class="media d-block room mb-0">
                  <figure>
                    <img src="assets/images/photos/<? echo $value['img']?>" alt="Generic placeholder image" class="img-fluid">
                  </figure>
                  <div class="media-body">
                    <h3 class="mt-0"><a href="#"><?php echo $value['judul'];?></a></h3>

                    <form>
                      <input type="button" value="Detail" onclick="window.location.href='detailpoto.php?id=<?php echo $value['id'];?>'" />
                    </form>
