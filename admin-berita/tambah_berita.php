...
if($_FILES['img']['name']){
	...
	if(!$_FILES['img']['error']){
		...
		if($valid_file == true)
		{
			...
			// simpan ke database
			mysqli_query($koneksi, "INSERT INTO berita SET catID='$id_kategori',judul='$judul',penulis='1',drafter='1',publisher='1', isi='$isi', tanggal='$tanggal', tanggal_post='$tanggalpost', jam='$jam', img='$nama_file_baru', publish='Y', viewed='100'");
